...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getTokenContract(variables?: GetTokenContractQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetTokenContractQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTokenContractQuery>(GetTokenContractDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getTokenContract');
    },
    ...
    getToken(variables?: GetTokenQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetTokenQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTokenQuery>(GetTokenDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getToken');
    }
  };
}
...
export type GetTokenContractQuery = (
  ...
  & { tokenContracts: Array<(
    { __typename?: 'TokenContract' }
    & Pick<TokenContract, 'name' | 'description'>
  )> }
);
