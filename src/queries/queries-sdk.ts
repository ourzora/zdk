...
export type MarketProperties = LilNounsAuction | NounsAuction | V1Ask | V1BidShare | V1Offer | V2Auction | V3Ask;
...
export type V3ReserveAuctionCoreEthV1AuctionProperties = {
  __typename?: 'V3ReserveAuctionCoreEthV1AuctionProperties';
  duration: Scalars['String'];
...
export type V3ReserveAuctionV1AuctionBidProperties = {
  ...
  auction: V3ReserveAuctionCoreEthV1AuctionProperties;
  extended: Scalars['Boolean'];
  firstBid: Scalars['Boolean'];
  price: PriceAtTime;
};
